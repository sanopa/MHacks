function myweathers($scope){
    $scope.weathers =[
        ...
        { title: 'cloudy', image:"assets/images/cloudy.png", objects:[{title:'sunglasses',val: false}, {title:'scarf', val:false}, {title:'pants',val:true}, {title:'shorts',val:false}, {title:'bathing suit',val: false}]},
