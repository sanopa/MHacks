function myweathers($scope){
    $scope.weathers =[
        ...
        { title: 'sunny', image:"assets/images/sunny.png", objects:[{title:'pajamas',val: false, image:"assets/images/pajamas.png"}, {title:'sunglasses',val:true, image:"assets/images/sunglasses.png"}, {title:'shorts', val:false, image:"assets/images/white-shorts-md.png"}, {title:'sneakers',val:true, image:"assets/images/tennis_shoes.png"}, {title:'rain boots',val:false, image:"assets/images/rain-boots.png"}]},
...
jQuery(document).ready(function($) {
  $.ajax({
  url : "http://api.wunderground.com/api/396bab011405eb77/conditions/q/autoip.jsonp",
  dataType : "jsonp",
...
jQuery(document).ready(function($) {
  ...
  getUrl = "http://api.wunderground.com/api/396bab011405eb77/conditions/q/".concat(zip,“.json”);
  }
  });
});
}
